...
class Encoder(nn.Module):
    ...
    def forward(self, inputs, hidden_states):
        ...
        # # Write your code here
        # # ==========================
        embedded = self.dropout(self.embedding(inputs.long()))
        output, hidden_states = self.rnn(embedded, hidden_states)
...
class DecoderAttn(nn.Module):
    ...
    def forward(self, inputs, hidden_states, mask=None):
        ...
        # # ==========================
        if self.mlp_attn:
            outputs = self.mlp_attn.forward(inputs, mask)
            outputs, hidden_states = self.rnn(outputs, hidden_states)
        else:
